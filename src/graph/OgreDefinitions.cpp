...
const std::map<gauntlet::EntityName, std::string> OgreUI::meshmap = {
		...
		{gauntlet::EntityName::MAP_TEST,          "map1.mesh"},
...
const std::map<gauntlet::SoundName,std::string>OgreUI::soundmap= {
	...
	{gauntlet::SoundName::MAGIC_EXPLOSION_1,	"mag_destruction_fireball_explosion_0.ogg"},
	{gauntlet::SoundName::MAGIC_EXPLOSION_2,	"mag_destruction_fireball_explosion_0.ogg"},
