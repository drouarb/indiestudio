...
namespace gauntlet
{
  namespace animations
  {
    ...
    static const std::map<animations::AnimationsListJson, std::pair<std::string, std::string>> jsonMap = {
	    ...
	    {SKELETON_FOOTMAN_COMBAT_MODE,                    {"skeleton_footman.json",  "Skeleton_combat_mode"}},
	    {SKELETON_FOOTMAN_DODGE_BACKWARDS,                {"skeleton_footman.json",  "Skeleton_dodge_backwards"}},
	    {SKELETON_FOOTMAN_DODGE_TO_LEFT,                  {"skeleton_footman.json",  "Skeleton_dodge_to_left"}},
	    {SKELETON_FOOTMAN_DODGE_TO_RIGHT,                 {"skeleton_footman.json",  "Skeleton_dodge_to_right"}},
	    {SKELETON_FOOTMAN_DUCK_BELOW_HIGH_SWING,          {"skeleton_footman.json",  "Skeleton_duck_below_high_swing"}},
	    {SKELETON_FOOTMAN_PARRY_A,                        {"skeleton_footman.json",  "Skeleton_parry_A"}},
	    {SKELETON_FOOTMAN_PARRY_B,                        {"skeleton_footman.json",  "Skeleton_parry_B"}},
